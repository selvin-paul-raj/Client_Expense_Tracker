...
function Transaction({ category, handler }){
    ...
    return (
        <div className="item  flex justify-center  py-2 rounded-lg border border-white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10   " style={{ borderRight : `8px solid ${category.color ??  "#e5e5e5"}`}}>
